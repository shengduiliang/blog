import{_ as s,c as a,a0 as p,o as e}from"./chunks/framework.P9qPzDnn.js";const l="/assets/xxl-job-executor-sample-executer-project.B7uFHMvr.png",b=JSON.parse('{"title":"执行器初始化流程","description":"","frontmatter":{},"headers":[],"relativePath":"xxl-job/executor.md","filePath":"xxl-job/executor.md"}'),t={name:"xxl-job/executor.md"};function i(r,n,o,c,d,u){return e(),a("div",null,n[0]||(n[0]=[p('<h1 id="执行器初始化流程" tabindex="-1">执行器初始化流程 <a class="header-anchor" href="#执行器初始化流程" aria-label="Permalink to &quot;执行器初始化流程&quot;">​</a></h1><p>前面详细分析了xxl-job-admin的流程，从这章开始，我们分析xxl-job的执行器流程。我们之前运行的是xxl-job-executor-sample-springboot这个项目，所以我们就从这个项目开始分析。</p><img src="'+l+`" width="400" alt="xxl-job-executor-sample-executer-project"><p>这个项目的结构还是很简单的，主要看XxlJobConfig和SampleXxlJob。SampleXxlJob是使用XxlJobConfig配置扫描的，直接看XxlJobConfig文件代码吧。</p><div class="language-XxlJobConfig vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">XxlJobConfig</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>@Configuration</span></span>
...
<span class="line"><span>  }</span></span>
<span class="line"><span>}</span></span></code></pre></div><h2 id="xxljobspringexecutor" tabindex="-1">xxlJobSpringExecutor <a class="header-anchor" href="#xxljobspringexecutor" aria-label="Permalink to &quot;xxlJobSpringExecutor&quot;">​</a></h2><p>可以看到声明了一个Bean，名字叫做xxlJobSpringExecutor，接下来我们这个类的代码。</p><div class="language-XxlJobSpringExecutor vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">XxlJobSpringExecutor</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>public class XxlJobSpringExecutor extends XxlJobExecutor implements ApplicationContextAware, SmartInitializingSingleton, DisposableBean {</span></span>
...
<span class="line"><span>  }</span></span>
<span class="line"><span>}</span></span></code></pre></div><p>由于XxlJobSpringExecutor继承了SmartInitializingSingleton接口，所以会调用afterSingletonsInstantiated方法</p><h2 id="jobhandler初始化" tabindex="-1">JobHandler初始化 <a class="header-anchor" href="#jobhandler初始化" aria-label="Permalink to &quot;JobHandler初始化&quot;">​</a></h2><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>public class XxlJobSpringExecutor extends XxlJobExecutor implements ApplicationContextAware, SmartInitializingSingleton, DisposableBean {</span></span>
...
<span class="line"><span>    }</span></span>
<span class="line"><span>  }</span></span>
<span class="line"><span>}</span></span></code></pre></div><p>可以看到这个方法就是扫描所有具有XxlJob注解的方法，然后注册这些方法。接下来看registJobHandler这个方法的实现。</p><div class="language-XxlJobExecutor vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">XxlJobExecutor</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>public class XxlJobExecutor  {</span></span>
...
<span class="line"><span>		}</span></span>
<span class="line"><span>	}</span></span>
<span class="line"><span>}</span></span></code></pre></div><p>由于是Spring环境，默认使用SpringGlueFactory。简单看一下GlueFactory这个工厂类的方法吧，这里就不细讲了。</p><div class="language-GlueFactory vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">GlueFactory</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>public class GlueFactory {</span></span>
...
<span class="line"><span>}</span></span></code></pre></div><h2 id="执行器初始化" tabindex="-1">执行器初始化 <a class="header-anchor" href="#执行器初始化" aria-label="Permalink to &quot;执行器初始化&quot;">​</a></h2><div class="language-XxlJobExecutor vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">XxlJobExecutor</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>public class XxlJobExecutor  {</span></span>
...
<span class="line"><span>  }</span></span>
<span class="line"><span>}</span></span></code></pre></div><h3 id="初始化执行器服务" tabindex="-1">初始化执行器服务 <a class="header-anchor" href="#初始化执行器服务" aria-label="Permalink to &quot;初始化执行器服务&quot;">​</a></h3><p>我们看一下initEmbedServer的执行方法，代码如下:</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>public class XxlJobExecutor  {</span></span>
...
<span class="line"><span>  }</span></span>
<span class="line"><span>}</span></span></code></pre></div><p>可以看到初始化了一个EmbedServer类，并且调用了EmbedServer的start方法，我们具体看一下对应的方法代码。</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>public class EmbedServer {</span></span>
...
<span class="line"><span>  }</span></span>
<span class="line"><span>}</span></span></code></pre></div><p>可以看到初始化了一个线程池，并且使用netty建立了一个服务器。核心地方我们查看EmbedHttpServerHandler这个处理类</p><h3 id="embedhttpserverhandler" tabindex="-1">EmbedHttpServerHandler <a class="header-anchor" href="#embedhttpserverhandler" aria-label="Permalink to &quot;EmbedHttpServerHandler&quot;">​</a></h3><div class="language-EmbedHttpServerHandler vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">EmbedHttpServerHandler</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>public static class EmbedHttpServerHandler extends SimpleChannelInboundHandler&lt;FullHttpRequest&gt; {</span></span>
<span class="line"><span>  @Override</span></span>
...
<span class="line"><span>    }</span></span>
<span class="line"><span>  }</span></span>
<span class="line"><span>}</span></span></code></pre></div><p>可以看到用刚才创建的线程池来处理admin下发的请求。</p><p>我们主要看/run分支的代码，可以看到调用了executorBiz#run方法，这个对应的实现是ExecutorBizImpl，我们看一下实现：</p><div class="language-ExecutorBizImpl vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">ExecutorBizImpl</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>public class ExecutorBizImpl implements ExecutorBiz {</span></span>
<span class="line"><span>  @Override</span></span>
...
<span class="line"><span>  }</span></span>
<span class="line"><span>}</span></span></code></pre></div><p>可以看到是从XxlJobExecutor拿到jobId对应的jobThread，然后将triggerParam参数放入到jobThread里面。看一下jobThread#pushTriggerQueue的方法</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>public class JobThread extends Thread {</span></span>
...
<span class="line"><span>  }</span></span>
<span class="line"><span>}</span></span></code></pre></div><p>最后让我们看一下jobThread的核心方法start。</p><div class="language-JobThread vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">JobThread</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>public class JobThread extends Thread {</span></span>
<span class="line"><span>	public void run() {</span></span>
...
<span class="line"><span>    }</span></span>
<span class="line"><span>  }</span></span>
<span class="line"><span>}</span></span></code></pre></div><p>上述将任务执行的代码省略了很多，只将核心的代码抽取出来。任务的执行是不断执行的，只有当任务停止了（toStop设置为ture），才跳出while循环。首先从triggerQueue队列中弹出触发参数，如果存在执行超时时间并大于0，则在规定的时间异步调用handler的execute方法执行任务，否则立即调用handler的execute方法执行任务。</p><p>handler#execute的代码比较简单，这里就不详细讲了。</p><h2 id="执行器注册" tabindex="-1">执行器注册 <a class="header-anchor" href="#执行器注册" aria-label="Permalink to &quot;执行器注册&quot;">​</a></h2><p>最后讲一下执行器的注册流程，在netty服务器初始化的代码中，可以看到一行注册执行器的代码。</p><div class="language-EmbedServer vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">EmbedServer</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>public class EmbedServer {</span></span>
<span class="line"><span>  public void start(final String address, final int port, final String appname, final String accessToken) {</span></span>
<span class="line"><span>    startRegistry(appname, address);</span></span>
<span class="line"><span>  }</span></span>
<span class="line"><span></span></span>
...
<span class="line"><span>  }</span></span>
<span class="line"><span>}</span></span></code></pre></div><p>我们看一下ExecutorRegistryThread的源码，如下所示</p><div class="language-ExecutorRegistryThread vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">ExecutorRegistryThread</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>public class ExecutorRegistryThread {</span></span>
...
<span class="line"><span>  }</span></span>
<span class="line"><span>}</span></span></code></pre></div><p>可以看到注册了一个守护线程registryThread，我们看看这个线程做了什么事情</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>registryThread = new Thread(new Runnable() {</span></span>
<span class="line"><span>  @Override</span></span>
<span class="line"><span>  public void run() {</span></span>
<span class="line"><span></span></span>
...
<span class="line"><span>    }</span></span>
<span class="line"><span>  }</span></span>
<span class="line"><span>});</span></span></code></pre></div><p>可以看到主要是每隔30秒，遍历adminBizList，然后调用adminBiz.registry注册和adminBiz.registryRemove移除注册。</p><p>对应的实现类是AdminBizClient，查看实现代码, 前面讲过postBody的实现，这里就不细说了。</p><div class="language-AdminBizClient vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">AdminBizClient</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>public class AdminBizClient implements AdminBiz {</span></span>
<span class="line"><span>  @Override</span></span>
...
<span class="line"><span>  }</span></span>
<span class="line"><span>}</span></span></code></pre></div>`,48)]))}const h=s(t,[["render",i]]);export{b as __pageData,h as default};
